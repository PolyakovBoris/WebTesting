...
class OperationsHelper(BasePage):
    ...
    def fill_post_info(self, title=None, description=None, content=None):
        ...
        if description:
            self.enter_text_into_field(TestSearchLocators.ids["LOCATOR_DESCRIPTION"], description,
                                       description_loc="description field")
        if content:
            self.enter_text_into_field(TestSearchLocators.ids["LOCATOR_CONTENT"], content,
                                       description_loc="content field")
    ...
    def fill_contact_form(self, name, email, content):
        ...
        self.enter_text_into_field(TestSearchLocators.ids["LOCATOR_CONTENT_FIELD"], content,
                                   description_loc="content field")
    ...
    def get_title_text(self):
        return self.get_text_from_element(TestSearchLocators.ids["LOCATOR_CHECK_POST"],
                                          description_loc="get title text")
